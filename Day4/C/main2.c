...
int interseccion(char *fr, char *sr)
{
    char *frn[2], *srn[2];
    int fri[2] = {0}, sri[2] = {0};
    ...
    if(fri[0] >= sri[0] && fri[0] <= sri[1])
    {
        return 1;
    }

    if(fri[1] <= sri[0] && fri[1] >= sri[1])
    {
        return 1;
    }

    if(sri[0] >= fri[0] && sri[0] <= fri[1])
    {
        return 1;
    }

    if(sri[1] <= fri[0] && sri[1] >= fri[1])
    {
        return 1;
    }
